                            ...
                            <form>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="inputStatus">Quotations</label>
                                        <select id="inputStatus" class="form-control custom-select">
                                            <option disable>Select Quotations</option>
                                            <option>2</option>
                                            <option>8</option>
                                            <option>10</option>
                                            <option>12</option>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                    <div class="card-body">
                        ...
                        <div class="">
                            <button  href ="add_purchases.php"class="btn btn-primary">Add</button>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="card-body">
                     ...
                     <div class="">
                        ...
                        <div class="row">
                           ...
                           <p> Total (Taka)</p>
                           <p>Due Amount (Taka)</p>
                           Discount (Taka)<input type="text">
                          <p> Amount Paid (Taka)<input type="text"></p>
                           <button class="btn btn-primary">submit</button>
                            </div>
                        </div>
                 </div>
