        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="product_unit.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Product Units</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="product_catogery.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="product_store6.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Product</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="Product-reviwes.php" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Product Reviwes
                                </p>
